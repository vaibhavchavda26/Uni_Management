...
def staff_home(request):
	...
	staff = Teachers.objects.get(admin=request.user.id)
	...
	return render(request, "teacher_template/staff_home_template.html", context)
...
def staff_apply_leave(request):
	print(request.user.id)
	staff_obj = Teachers.objects.get(admin=request.user.id)
	leave_data = LeaveReportStaff.objects.filter(staff_id=staff_obj)
	context = {
		"leave_data": leave_data
	}
	return render(request, "teacher_template/staff_apply_leave_template.html", context)
...
def staff_feedback(request):
    return render(request, "teacher_template/staff_feedback_template.html")
...
def staff_profile(request):
	...
	staff = Teachers.objects.get(admin=user)

	context={
		"user": user,
		"staff": staff
	}
	return render(request, 'teacher_template/staff_profile.html', context)
...
def staff_profile_update(request):
	if request.method != "POST":
		...
		try:
			...
			staff = Teachers.objects.get(admin=customuser.id)
